...
class Supernova(object):
    ...
    def _extract_lc_params(self):
        ...
        self.lc_parameters = {'tmax':np.round(self.tmax, 3), 'tmax_err':np.round(self.tmax_err, 3),
                              'Bmax':np.round(self.mmax, 3), 'Bmax_err':np.round(self.mmax_err, 3),
                              'dm15':np.round(self.dm15, 3), 'dm15_err':np.round(self.dm15_err, 3),
                              'colour':np.round(self.colour, 3), 'colour_err':np.round(self.colour_err, 3),
                              'sBV': np.round(self.stretch, 3), 'sBV_err': np.round(self.stretch_err, 3)}

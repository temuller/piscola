...
import piscola
from piscola.extinction_correction import calculate_ebv, redden, deredden, extinction_filter, extinction_curve
...
class TestPiscola(unittest.TestCase):
    ...
    def test_calculate_ebv(self):
        ...
        err_msg = 'Difference in E(B-V) between calculated and reference value is too large.'
        np.testing.assert_allclose(ebv_SF2011, ref_ebv_SF2011, rtol=0.02, err_msg=err_msg)
        np.testing.assert_allclose(ebv_SFD1998, ref_ebv_SFD1998, rtol=0.02, err_msg=err_msg)
    ...
    def test_reddening_laws(self):
        ...
        for reddening_law in ['fitzpatrick99', 'ccm89', 'odonnell94', 'calzetti00', 'fm07']:
            with warnings.catch_warnings():
                warnings.filterwarnings("ignore", category=DeprecationWarning)
    ...
    def test_visual_extinction(self):
        ...
        ref_A_V = 0.1368  # from https://irsa.ipac.caltech.edu/cgi-bin/bgTools/nph-bgExec

        err_msg = 'Difference in A_V between calculated and reference value is too large.'
